...
const products = {
  ...
  mango: {
    ...
    price: "₹149",
    images:[
    "images/Mango_pro.png",
    "images/MANGO_image.png",
    "images/Mango_info.png"
    ],
...
"Made from real Alphonso mangoes using freeze-drying technology that preserves taste and delivers a natural light & crunchy snack.",
  ...
  jamun: {
    ...
    price: "₹149",
    images:[
    "images/Jamun_pro.png",
    "images/JAMUN_image.png",
    "images/Jamun_info.png"
    ],
...
"Crafted from real jamun fruit with a unique sweet-tangy flavour and satisfying crunch.",
  ...
  corn: {
    ...
    images:[
    "images/Corn_pro.png",
    "images/CORN_image.png",
    "images/Corn_info.png"
    ],
